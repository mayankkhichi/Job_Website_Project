...
function Box() {
  return (
      ...
      <div className='border-2  w-[80%] h-[80%] rounded-[25px] mt-[40px]'>
       <p class="m-2 text-md font-bold text-[#8C8594] ">TRENDING AT #1</p>
       <h3 class="mb-0 m-4 text-2xl md:mt-8">Jobs for Freshers</h3>
       <p  class="text-shadow:0px 0px 2px #000 stroked bg-text absolute left-[24px] top-[40%] whitespace-nowrap text-[28px] font-bold text-transparent transition-all duration-500 md:left-[75px] md:top-[47%] md:text-[64px]">Jobs for Freshers</p>
