  ...
  return (
    <div className={`${styles.sidebar} ${isOpen ? styles.open : ""}`}>
      ...
      <ul className={styles["sidebar-menu"]}>
        <li onClick={() => handleTabClick("jobs")} className={styles.sidename}>Jobs</li>
        <div className={styles.line}></div>
        <li onClick={() => handleTabClick("search")} className={styles.sidename}>Search Candidate</li>
        <div className={styles.line}></div>
        <li onClick={() => handleTabClick("setting")} className={styles.sidename}>profile</li>
      </ul>
